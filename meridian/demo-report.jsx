...
const RESEARCH_DATA = {
  organization: {
    ...
    role: "Deployer",
    sector: "Financial services — FCA-authorized consumer lender",
    size: "620 employees",
  ...
  jurisdictions: [
    ...
    },
    {
      ...
      tier: 1,
      tierLabel: "Directly Applicable",
      trigger: "FCA-authorized deployer; UK GDPR Art.22 automated decision-making; ICO AI guidance",
      confidence: "SETTLED",
  ...
  actionPlan: [
    ...
    { priority: 7, action: "EU AI Act high-risk deployer obligations program", rationale: "Full Annex III obligations in force August 2026; program needs 12+ months lead time.", jurisdictions: ["EU AI Act"], effort: "Very High", owner: "program Office + Compliance", deadline: "Aug 2026", horizon: "medium" }
  ],
  unknowns: [
    ...
    { topic: "UK primary AI legislation timeline", reason: "Government has signaled sector-led approach but statutory duty of care remains possible.", recommendation: "Monitor DSIT consultations quarterly." },
...
function OverviewTab() {
  const { organization, topObligations, jurisdictions, generatedDate } = RESEARCH_DATA;
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ background: "#FEF9C3", border: "1px solid #FDE047", borderRadius: 8, padding: "10px 14px", display: "flex", gap: 10, alignItems: "center" }}>
        ...
        <p style={{ fontSize: 12, color: "#713F12", margin: 0 }}>
          <strong>Freshness:</strong> AI regulation changes rapidly. This report reflects positions as of {generatedDate}. Positions marked [PENDING] or [UNDER REVIEW] should be rechecked before use in live compliance programs. This is research output, not legal advice.
        </p>
      </div>

      {/* Org profile */}
      <div style={{ background: "white", borderRadius: 10, border: "1px solid #E2E8F0", padding: 18 }}>
        <h3 style={{ fontSize: 13, fontWeight: 700, color: "#64748B", textTransform: "uppercase", letterSpacing: "0.05em", margin: "0 0 12px" }}>organization Profile</h3>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px 24px" }}>
          {[
            ["Role", organization.role],
            ["Sector", organization.sector],
            ["Established", organization.established],
            ["AI Activity", organization.aiActivity],
            ["Users In", organization.usersIn.join(", ")],
            ["Oversight Model", organization.humanOversight],
          ].map(([k, v]) => (
            <div key={k}>
...
export default function App() {
  ...
  const { organization, generatedDate, jurisdictions } = RESEARCH_DATA;
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start", marginBottom: 16 }}>
            <div>
              ...
              <h1 style={{ fontSize: 20, fontWeight: 800, margin: "0 0 4px", letterSpacing: "-0.02em" }}>{organization.name}</h1>
              <p style={{ fontSize: 13, color: "#94A3B8", margin: 0 }}>{organization.sector} · {organization.role} · {organization.established}</p>
            </div>
            <div style={{ textAlign: "right" }}>
              <p style={{ fontSize: 12, color: "#64748B", margin: "0 0 4px" }}>Generated {generatedDate}</p>
              <p style={{ fontSize: 10, color: "#475569", margin: "0 0 6px" }}>MERIDIAN</p>
