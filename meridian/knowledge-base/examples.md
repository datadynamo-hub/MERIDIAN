# examples.md
# MERIDIAN — Worked Examples

These three examples show what the elicitation, applicability routing, live research, and output look like for different organization profiles. They are the benchmark for what "good" looks like from this researcher.
...
*What does your organization do in relation to AI?*
...
**User:** Financial services — we're FCA-authorized, consumer lending.

**Researcher:** *Where is the organization established, and where are your borrowers?*
...
- **UK — Tier 1:** FCA-authorized deployer; FCA Consumer Duty applies; ICO UK GDPR Art.22 automated decision-making applies now; PRA SS1/23 model risk management applies.
...
**Novel discovery format (if found):** "AEDT-AEDT-N01 — Illinois AEDT Bill enacted [date]. [Source: ilga.gov, Tier 1]. This organization's employer customers with Illinois applicants would face new disclosure and audit obligations from [effective date]. Recommend adding Illinois to compliance scope and updating customer contractual terms."
...
- **International — Tier 3:** ISO/IEC 42001, OECD principles for AI governance program.
