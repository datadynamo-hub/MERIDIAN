...
const MATURITY_OPTIONS = [
  ...
  { value: "audit", label: "Audit / assurance", desc: "Validating an existing program against current regulations" },
];
...
export default function ElicitationWidget() {
  ...
  const buildProfile = () => {
    ...
    return `ORGANIZATIONAL PROFILE — CONFIRMED
  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "32px 28px 0" }}>
        ...
        {/* Stage 1 */}
        <SectionHeader stage="Stage 1" title="Your organization" color="#3B82F6" complete={sectionComplete.org} />
