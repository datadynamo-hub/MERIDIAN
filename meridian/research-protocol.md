...
# MERIDIAN — Live Research Protocol
...
→ Check publication dates — prioritize anything newer than the brief's `last verified` date
...
→ Confirm: scope (does it apply to this organization's profile?)
```
...
- Does this apply to this organization's role (provider/deployer/integrator)?
...
```markdown
# Session Discoveries — [organization Name] — [Date]
...
**Applicability to this organization:** [Yes / Conditional / No — with one-sentence reason]
**Confidence:** [Flag]
**Summary:** [2–3 sentences on what it says and why it matters]
**Recommended action:** [What the organization should do in response]
