...
A summariser takes what is in front of it and condenses it.
...
A director reading the Overview tab understands their top obligations in 60 seconds. A compliance manager reading the Obligations tab has everything they need to build a programme. An auditor reading the Sources tab can trace every claim to its primary source.
