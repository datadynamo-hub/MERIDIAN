...
It researches. Not summarises.

When you describe your organisation and AI use case, this researcher:
...
4. Produces a structured, navigable HTML report covering your obligations, mapped by jurisdiction, prioritised by urgency
...
Go to claude.ai → Projects → New Project. Name it something like "ARIA."
...
**You say:** "I need to understand what AI regulations apply to my organisation."
...
3. Assesses whether it applies to your specific organisation profile
...
- **Tier 2:** Specialist law firms, Big 4 advisory publications, established think tanks, recognised industry bodies
...
| Tab | Contents |
|---|---|
| Overview | Organisation profile, top 5 obligations by urgency, jurisdiction matrix |
| Map | World map colour-coded by applicability tier, click for jurisdiction detail |
...
| Action Plan | Prioritised compliance sequence with effort sizing and ownership |
...
**This researcher produces research output, not legal advice.** Regulatory positions — even those marked [SETTLED] — should be confirmed with qualified legal counsel in each relevant jurisdiction before use in live compliance programmes.
...
Built using interpretable context methodology. Each file does one job. The researcher's behaviour is fully legible — every rule, source, and routing decision is readable in plain markdown. There is no hidden logic.
